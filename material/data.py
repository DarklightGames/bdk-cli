...
class UMaterial:
    FallbackMaterial: UReference = None
...
class UShader(URenderedMaterial):
    Diffuse: UReference = None
    Opacity: UReference = None
    Specular: UReference = None
    SpecularityMask: UReference = None
    SelfIllumination: UReference = None
    SelfIlluminationMask: UReference = None
    Detail: UReference = None
...
class UCombiner(UMaterial):
    ...
    Material1: UReference = None
    Material2: UReference = None
    Mask: UReference = None
